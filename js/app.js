...
6. NO incluyas saludos, títulos, HTML ni despedidas, ve directo al texto del informe en texto plano.`;
        ...
        infTexto.innerHTML = `
            <div style="font-family: 'Inter', Arial, sans-serif; color: #333; padding: 20px 30px; background: white;">
                <!-- Encabezado -->
                ...
                <div style="margin-bottom: 25px; line-height: 1.8; font-size: 14px; background: #f8fafc; padding: 15px; border-radius: 8px;">
                    ...
                    <p style="margin:0;"><strong>Período evaluado:</strong> ${fechaDesdeStr || 'Inicio'} a ${fechaHastaStr || 'Fin'}</p>
                </div>
                ...
                <div style="margin-top: 60px; text-align: center; page-break-inside: avoid;">
                    <hr style="border: none; border-top: 1px solid #94a3b8; width: 250px; margin: 0 auto 10px auto;">
                    <p style="margin: 0; font-weight: bold; font-size: 14px;">Coordinador Académico UCIP</p>
                    <p style="margin: 0; color: #64748b; font-size: 12px;">Hospital Pablo Tobón Uribe</p>
                    <p style="margin: 5px 0 0 0; color: #94a3b8; font-size: 11px;">Fecha de generación: ${new Date().toLocaleDateString('es-CO')}</p>
                    <p style="margin: 3px 0 0 0; color: #cbd5e1; font-size: 10px;">IA Model: ${selectedModel.replace('models/', '')}</p>
                </div>
            </div>
        `;
