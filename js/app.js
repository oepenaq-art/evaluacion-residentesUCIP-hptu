...
4. "Concepto Final": Un breve dictamen de cierre.`;
        ...
        // Esto evita errores 404 si Google actualiza los nombres (ej. gemini-3.0-pro)
        ...
        // Filtrar modelos que soporten generación de texto y se llamen gemini
        ...
        // Buscar un modelo pro, si no hay, buscar un flash, si no, el primero
        ...
        console.log("Usando modelo dinámico de Gemini:", selectedModel);

        // 2. GENERAR EL REPORTE CON EL MODELO DESCUBIERTO
        ...
        if (!response.ok) {
            ...
            throw new Error(`Fallo al generar texto: ${errorDetalle}`);
        }
